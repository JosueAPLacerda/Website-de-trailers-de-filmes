...
def main():
    ...
    pi = media.Movie("Pi",
                     "Pi (stylized as π) is a 1998 American psychological thriller film written and directed by Darren Aronofsky in his directorial debut.",
                     "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRttvbw14rh6S0ESqc3hopg71rylHYRtmcjSGe15LK_Z4_ZPCvu",
                     "https://www.youtube.com/watch?v=gtLzuHd1mj4",
                     "08/07/1998")

    seven = media.Movie("Seven",
                        "Seven is american neo-noir crime thriller film directed by David Fincher and written by Andrew Kevin Walker.",
    ...
    on_the_road = media.Movie("On the Road",
                              ...
                              "https://upload.wikimedia.org/wikipedia/pt/thumb/8/8f/On_the_Road.jpg/200px-On_the_Road.jpg",
