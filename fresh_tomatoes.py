...
# Layout da página principal e da barra do título
main_page_content = '''
<!DOCTYPE html>
<html lang="en">
  <body>
...
def create_movie_tiles_content(movies):
    ...
    content = ''
    for movie in movies:
        # Extrai o ID do youtube de cada url
        youtube_id_match = re.search(r'(?<=v=)[^&#]+', movie.trailer_youtube_url)
        youtube_id_match = youtube_id_match or re.search(r'(?<=be/)[^&#]+', movie.trailer_youtube_url)
        trailer_youtube_id = youtube_id_match.group(0) if youtube_id_match else None

        # Anexa o bloco do filme com seu conteúdo preenchido
...
def open_movies_page(movies):
    ...
    # Substitui o marcador de posição dos blocos de filme pelo conteúdo real gerado dinamicamente
